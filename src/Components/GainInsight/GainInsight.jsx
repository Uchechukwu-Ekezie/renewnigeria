      ...
      <div className="max-w-screen-xl px-4 mx-auto text-center">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {reports.map((report, index) => (
            <div
              key={index}
              className="flex flex-col bg-[#FFFFFF] top-[20px] bottom-[20px]  w-[290px] h-[415px] items-center p-4 text-white transition-transform transform hover:scale-105 hover:shadow-lg"
            >
              {/* Report Image */}
              <img
                src={report.image}
