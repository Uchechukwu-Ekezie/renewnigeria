    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center mx-auto max-w-screen-2xl lg:h-[330px]">
        ...
        <img
          src={nigeria}
          alt="Renew Nigeria"
          className="absolute mt-[110%] md:mt-[35%] md:w-[70vw] md:left-[9%] lg:mt-[-1%] lg:top-[35%] 2xl:top-[50%] md:top-[170%] left-[10%] w-[79vw]  lg:w-[800px] 2xl:w-[1068px] 2xl:left-[15%] lg:left-[16%] lg:h-[270.82px] 2xl:h-[356.82px] "
        />
        ...
        <img
          ...
          className="absolute mt-[110%] right-[2%] w-[15vw] md:mt-[35%] md:w-[25vw] lg:mt-[9%] lg:w-[200px] 2xl:top-[10%] md:top-[165%] lg:top-[9%] lg:right-[10%]"
        />
        ...
        <img
          src={staff}
          alt="Staff"
          className="absolute mt-[110%] left-[-1%] w-[24vw] md:mt-[95%] md:w-[25vw] md:left-[-4%] lg:mt-[43%]  2xl:left-[-1%] 2xl:w-[310px] 2xl:mt-[55%] sm:left-[1%] lg:left-[1%]"
        />

        {/* Main Text */}
       
  
          <p className="absolute top-[-90%] text-center p-2 text-[4vw] mt-[100%] lg:mt-[55%]  2xl:text-[2vw] 2xl:ml-[12.2%]  lg:ml-[16%]  font-bold leading-[1] md:text-[4vw] lg:text-[27px] lg:text-left 2xl:text-left md:top-[-190%] md:left-[2%] md:mt-[80%] 2xl:top-[-110%] lg:top-[-98%] lg:p-0 text-white font-raleway ">
            FIRST NATIONAL LEGISLATIVE SUMMIT & EXPO ON <br /> RENEWABLE ENERGY
          </p>

          {/* Date and Location */}
          <p className=" absolute mt-[245%] text-[4vw]  text-white font-semibold md:text-[3vw] md:mt-[200%] lg:mt-[50%] lg:text-[22px] lg:text-left 2xl:ml-[-32%] lg:ml-[-38.5%] text-center">
          ...
          <img
            src={year}
            alt="2025"
            className="absolute w-[40vw] md:mt-[140%] md:w-[35vw] lg:w-[30vw] lg:mt-[50%] lg:ml-[30%] mt-[170%]  2xl: 2xl:left-[25%] ]"
          />
