...
const PricingPlans = () => {
  return (
    ...
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-green-900/30 via-green-600/20 to-transparent"></div>

      <div className="relative container max-w-screen-lg mx-auto text-center">
        {/* Heading Section */}
