...
import video1 from "../../Assets/Frame.png"
const VideoGallery = () => {
  return (
        ...
        {[1, 2, 3].map((item, index) => (
          ...
          >
            ...
            {/* <button className="absolute inset-0 flex justify-center items-center">
              <div className="w-12 h-12 bg-green-500 rounded-full flex justify-center items-center shadow-md">
